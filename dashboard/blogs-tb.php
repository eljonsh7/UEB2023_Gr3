            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Blogs table</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Blogs table</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
				...
				<tr>
					...
					<th></th>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '
				  			<tr>
                <td><img src="../' . $row['Image'] . '"  width="150px" style = "border-radius: 10px"></td>
					...
					';
                                ...
                                if (isset($_GET['mode'])) {
                                    ...
                                    $sql = "SELECT * FROM `blogs` WHERE `ID` = $idRemove";
                                    $result = mysqli_query($conn, $sql);
                ...
                <div class="modal-buttons">
						      ...
						      <a href="blogs-tb.php" class="btn btn-success text-white" style="margin:2%;">No</a></button>
                                ...
                                if (isset($_GET['confirm'])) {
                                    ...
                                    // Retrieve the cover image path from the database for the specified blog entry
                                    $sql = "SELECT `Image` FROM `blogs` WHERE `ID` = $removeID";
                                    $result = mysqli_query($conn, $sql);
                                    $row = mysqli_fetch_assoc($result);
                                    $coverImagePath = '../' . $row['Image'];
                                    echo $coverImagePath;
                                    ...
                                    $sql = "DELETE FROM `blogs` WHERE `ID` = $removeID";
