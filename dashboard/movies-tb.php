        ...
        <div class="col-md-6" style="display: flex; justify-content: center;">
          <form id="movie-add" method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control dark" type="date" id="date" placeholder="Date:" name="date">
            </div>
            ...
            <div class="form-group">
              ...
              <input class="form-control dark" type="text" id="length" placeholder="Length:" name="length">
            </div>
            <br>
