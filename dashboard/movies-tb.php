                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                ...
                                if (isset($_GET['search'])) {
                                    $search = $_GET['search'];
                                    $sql = "SELECT * FROM `content` WHERE type = 'movie' and Title like '%{$search}%' LIMIT $start_from, $results_per_page";
                                    $sql1 = "SELECT * FROM `content` WHERE type = 'movie' and Title like '%{$search}%'";
                                ...
                                echo '<form action="movies-tb.php?page=' . $page . '" method="get" class="form-flex" style="display: flex;" onsubmit="return addSearchTermToAction()">
                            ...
                            <button type="submit" class="btn btn-primary mb-2">Go</button>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editDetails.php?detailsID=' . $row['ID'] . '&type=Movie&mode=info">' .
                                        $row['Title'] . '</a></td>
                                    <td>' . $row['Date'] . '</td>
                                    <td>' . $row['Rating'] . '</td>
                                    <td>' . $row['Director'] . '</td>
                                    ...
                                    <td><a href="movies-tb.php?removeID=' . $row['ID'] . '&mode=remove"
                                            class="btn btn-primary text-white">x</a></td>
                                </tr>
                                ';
                                }
                                echo '
                                ...
                                <div class="overlay">
                                    <div class="modal">
                                        ...
                                        <p>Are you sure you want to remove "' . $row['Title'] . '" from our database?
                                        </p>
                                        <div class="modal-buttons">
                                            <a href="movies-tb.php?removeID=' . $_GET['removeID'] . '&mode=remove&confirm=1"
                                                class="btn btn-primary text-white"
                                                style="margin:2%;color:white;">Yes</a>
                                            <a href="movies-tb.php" class="btn btn-success text-white"
                                                style="margin:2%;">No</a></button>
                                        </div>
                                    </div>
                                </div>
